...
class HeatPump(Model):
    ...
    def __init__(
        ...
        self.cop = self.n_th * ((self.t_snk + 273.15) / (self.t_snk - self.t_i_src))
        ...
        self.t_o_src = self.t_i_src - self.p_srce / self.m_dot_src / self.fluid_src.Cp

    def step(self, step, unit="seconds"):
        super().step(step, unit)

        self.fluid_src.T = (self.t_i_src + self.t_o_src) / 2 + 273.15
